    ...
    <footer className="bg-[#008e4ed3] text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="text-sm">
          ...
          <ul className="space-y-2">
            <li><Link href="/categories/%D0%A2%D1%80%D0%B0%D0%BA%D1%82%D0%BE%D1%80%D0%B8%20%D0%92%D0%B5%D0%BB%D0%B8%D0%BA%D0%BE%D1%97%20%D0%9F%D0%BE%D1%82%D1%83%D0%B6%D0%BD%D0%BE%D1%81%D1%82%D1%96" className="hover:underline">Шини для тракторів</Link></li>
